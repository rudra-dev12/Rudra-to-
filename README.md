...
<head>
  ...
  <style>
    ...
    * {scrollbar-width: none; -ms-overflow-style: none;}
    ...
    #bodyblur{opacity:.3;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.5);transition:all 1s ease;} 
    ...
    .swiper-pagination{display:none;margin-bottom:25vh}
    ...
    .sembunyi, #linkmp3{display: none !important;}
    ...
    .stiker img{width:90px;height:90px;box-shadow: 0 4px 30px rgba(255,255,255, 0.3);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);background: rgba(255, 255, 255, .3);border: 3px solid rgba(255, 255, 255, 1);border-radius: 50%;padding:10px;}
    ...
    .merah{color:red}
    .kuning{color:yellow}
    .putih{text-shadow:none;padding-left:8px;padding-right:8px;padding-top:2px;padding-bottom:2px;background-color:white;border-radius:12px}
    ...
    .heart-icon {z-index:100;width: 20px;height: 20px;position: fixed;animation:  heartMove linear 1;top: -10vh;}
    ...
    @keyframes moving {from {transform: translateY(0);} to {transform: translateY(3px);} }
    
    .overlay {position: fixed;top: 0;left: 0;width: 100%;height: 100%;display: flex;justify-content: center;align-items: center;background:rgba(0,0,0,.7);z-index:100;}
    .loading-message {font-size: 13px;text-shadow: 0px 2px 2px rgba(0, 0, 0, .8);color:white;text-align: center;}
    .blocklove{display: flex;flex-direction: column;justify-content: center;align-items: center;}
    ...
    .blocktext{margin-top:10px;margin-bottom:-40px;max-width:300px;position:relative;width:100%;height: 230px; overflow: auto;background-color:none;}
    ...
    .main-card{margin-top:-10px;display:flex;flex-direction:column;align-items:center;z-index:999}
    .game-board{margin-top:10px;display:grid;grid-template-columns:repeat(4,40px);grid-gap:10px;transform:scale(1);transition:transform 1s ease;}
    .card{font-family:Arial,sans-serif;width:40px;height:40px;background-color:rgba(255,255,255,.5);display:flex;align-items:center;justify-content:center;font-size:.5em;/*cursor:pointer;*/border-radius:12px;transform:scale(0);}
    .card.flipped{font-size:1.2em;background-color:rgba(255,255,255,.3);color:#2c3e50;transition:all .5s ease}
...
<body>
   ...
   <!-- Background Music -->
   <audio src="./assets/foreveryoung.mp3" id="linkmp3"></audio>
  
   <!-- Overlay -->
   <div class="overlay"><div id="loveIn" class="blocklove"></div></div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div id="stiker1" class="scale0 stiker">
                    <img src="https://htmlku.com/0/panda/hiya.gif" />
                </div>
                <h1 id="teks1" class="scale0 quicksand" style="font-size: 22px;">Hello There 🫢<br><br> >>>>
                </h1>
            </div>

            <div class="swiper-slide">
                <div id="stiker2" class="scale0 stiker">
                    <img src="./assets/weee.gif" />
                </div>
                <h1 id="teks2" class="scale0 quicksand" style="font-size: 20px;">I Have Something For You 😝<br><br> >>>></h1>
            </div>
            ...
            <div class="swiper-slide">
                ...
                <!-- Memory Game -->
                <div class="main-card">
                  <h1 id="teks3" class="scale0 quicksand" style="font-size: 20px;">Try to Solve<br><i class="pink">this Memory Game</i>! 😆</h1>
                  <div class="game-board">
                    <div class="card" data-emoji="🫶"></div>
                    <div class="card" data-emoji="❤️"></div>
                    <div class="card" data-emoji="🥳"></div>
                    <div class="card" data-emoji="💞"></div>
                    ...
                    <div class="card" data-emoji="🩷"></div>
                    <div class="card" data-emoji="🥳"></div>
                    <div class="card" data-emoji="😍"></div> <!--onclick="endGame()"-->
                  </div>
                </div>
                
                <!-- When Completed -->
                <div id="stiker4" class="abs scale0 stiker" style="margin-top:70px">
                    <img id="stikerAkhir1" src="./assets/pandapanah.gif" />
                    <img id="stikerAkhir2" class="sembunyi" src="./assets/cilukba.gif" />
        
                    <img id="stikerAkhir100" class="sembunyi" src="https://htmlku.com/0/panda/terlope.gif" />
                </div>
                <div id="scroll-container" class="blocktext scale0 abs">
                    <h1 id="teks4" class="quicksand" style="font-size: 18px;font-weight:400"><b style="font-size:22px;font-weight:700;">Yay!! 🥳</b><br><br>I want to tell you something 🫣<br><br>Wait a moment~ 😋</h1>
                </div>
            </div>
...
function katanimasi2() {
    ...
    new TypeIt("#teks4", {
        speed: 26, // typing speed
        deleteSpeed: 13, // deletion speed
        cursor: true
    })
    .type('According to <b>biology</b>, you are<br> <b><span class="pink">7%</span> blood</b>~')
    .pause(700) // pause 0.7 second after typing finishes
    .delete(78)
    .pause(400) // pause before next text
    .type('According to <b>chemistry</b>, you are<br> <b><span class="pink">70%</span> water</b>~')
    .pause(700)
    .delete()
    .pause(400)
    .type('According to <b>physics</b>, you are<br> <b><span class="pink">99%</span> empty space</b>~')
    .pause(700)
    .delete()
    .pause(400)
    .exec(() => {
    ...
    .type('But <b>in my opinion</b>, you are<br><b><span class="pink">1000%</span> my love</b> 🫣❤️')
    .exec(() => {
        teks4.innerHTML = 'But <b>in my opinion</b>, you are<br><b><span class="pink">1000%</span> my love</b> 🫣❤️' + `<br><br><span id="teksLove"></span>`;
...
function katanimasi3(){
    initeksAkhir = `ᯓᡣ𐭩<br><b>Dearest my love</b>,<br>the sweetest, funniest, most adorable<br><b>stay healthy, my dear 😍😋🩷</b>`;
    new TypeIt("#teksLove", {
...
document.getElementById("loveIn").onclick = function() {
    if (sudahKlik) {
        ...
        sudahKlik = true;
        document.getElementById('loveIn').innerHTML = '<style>.lovein svg{animation:none;stroke:#ff0000;stroke-width:1.3;fill:none
